...
```
> To what properties are available on the GraphQL Input type `RootQueryToProductConnectionWhereArgs`. You can search this type and more using the **Docs** panel on the right side of [Playground](/playground).